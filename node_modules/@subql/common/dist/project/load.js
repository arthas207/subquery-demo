...
exports.getSchemaPath = exports.getManifestPath = exports.loadFromJsonOrYaml = void 0;
...
function getSchemaPath(file) {
    const yamlFile = loadFromJsonOrYaml(getManifestPath(file));
    if (yamlFile.specVersion === '0.0.1') {
        return path_1.default.join(file, yamlFile.schema);
    }
    return path_1.default.join(file, yamlFile.schema.file);
}
