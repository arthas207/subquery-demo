...
exports.isSubstrateTemplates = exports.isRuntimeDs = exports.isCustomDs = exports.isCallHandlerProcessor = exports.isEventHandlerProcessor = exports.isBlockHandlerProcessor = void 0;
...
function isSubstrateTemplates(templatesData, specVersion) {
    return (isRuntimeDs(templatesData[0]) || isCustomDs(templatesData[0])) && (0, semver_1.gte)(specVersion, '0.2.1');
}
exports.isSubstrateTemplates = isSubstrateTemplates;
